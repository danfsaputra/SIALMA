...
import Form from "@/Pages/Sata/Sarpras/Form.vue";
...
const fetchData = () => {
    axios
        .get(
            `/api/sarpras?page=${currentPage}&perPage=${perPage.value}&sortField=${sortField.value}&sortOrder=${sortOrder.value}&search=${search.value}`
        )
        .then((response) => {
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    >
                        ...
                        ></Column>
                        <Column
                            field="jumlah_tidak_layak"
                            header="Jumlah Tidak Layak"
                            sortable
                        ></Column>
