...
import Form from "@/Pages/Trantibum/Perda/Form.vue";

const fetchedData = ref([]);
const perPage = ref(10);
const totalItems = ref(0);
const sortField = ref("perda");
...
const fetchData = () => {
    axios
        .get(
            `/api/perda?page=${currentPage}&perPage=${perPage.value}&sortField=${sortField.value}&sortOrder=${sortOrder.value}&search=${search.value}`
        )
        .then((response) => {
